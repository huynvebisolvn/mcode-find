...
MenuNhiemVuNgay() {
    ...
    Gui, Add, Text, w200, Chon vi tri like:
    Gui, Add, Checkbox, vEnableLikeViTri1 Checked w200, Vi tri 1
    Gui, Add, Checkbox, vEnableLikeViTri2 w200, Vi tri 2
    Gui, Add, Checkbox, vEnableLikeViTri3 w200, Vi tri 3
    

    Gui, Add, Button, gLikeTrangVien Default w200, Like trang vien

    Gui, Show,, Menu
    return

    LikeTrangVien:
        global StartPos, EnableLikeViTri1, EnableLikeViTri2, EnableLikeViTri3
        Gui, Submit, NoHide
        Gui, Destroy
