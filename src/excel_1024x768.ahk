...
; Show mouse coordinates for debugging
ShowMousePosition() {
    global ShowMouseCoords
    if (ShowMouseCoords) {
        MouseGetPos, xpos, ypos
        ToolTip, X: %xpos%  Y: %ypos%, xpos + 15, ypos + 15
    }
    return
}
...
RunPriceTargetScript() {
    ...
    if (ok:=FindText(RefreshX := "wait", RefreshY := 0.5, 287-150000, 93-150000, 287+150000, 93+150000, 0, 0, Refresh))
    {
        ...
        if (ok:=FindText(PlusMaxX := "wait", PlusMaxY := 0.5, 975-150000, 488-150000, 975+150000, 488+150000, 0, 0, PlusMax))
        {
            ...
            Loop
            {
                ...
                if (ok:=FindText(FirstTargetX := "wait", FirstTargetY := 0.5, 860-150000, 585-150000, 860+150000, 585+150000, 0, 0, SelectedPriceTarget))
                {
...
Monghoaluc() {
    ...
    loop
    {
      ...
      if (ok:=FindText(MongHoaX := "wait", MongHoaY := 5, 18-150000, 130-150000, 18+150000, 130+150000, 0, 0, MongHoa))
      {
        MouseClick, left, MongHoaX, MongHoaY
        Sleep, 1000
        ; TODO
        MouseClick, left, 98, 650
        Sleep, 1000
        MouseClick, left, 720, 300
        Sleep, 1000
        FormatTime, CurrentDate, , dd/MM/yyyy
        Send, {Text}%CurrentDate%ChoiGameVuiVe
        ; TODO
        MouseClick, left, 800, 560
        break
      }
    }
    Thu:="|<>*169$19.U00M00C003U00s00C003U00s00C087UA3sC3yD3ny3Uy1UC1U000000000000000004"
    if (ok:=FindText(ThuX := "wait", ThuY := 1, 22-150000, 235-150000, 22+150000, 235+150000, 0, 0, Thu))
    {
      ...
      if (ok:=FindText(NhanNhanhX := "wait", NhanNhanhY := 1, 285-150000, 731-150000, 285+150000, 731+150000, 0, 0, NhanNhanh))
      {
...
Haocam() {
    ...
    loop
    {
      ...
      Sleep, 2000
      MouseClick, left, 960, 170
      Sleep, 1000
      MouseClick, left, 660, 270
...
NhanThuong(username, index) {
    ...
    ; TODO
    MouseClick, left, 328, 650
    Sleep, 500
    MouseClick, left, 328, 650
    MouseClick, left, 480, 650
    Sleep, 500
    MouseClick, left, 480, 650
    MouseClick, left, 632, 650
    Sleep, 500
    MouseClick, left, 632, 650
    return
}
...
DaoKhoan() {
    ...
    Loop, 600
    {
        ...
        if (ok:=FindText(X, Y, 649-150000, 464-150000, 649+150000, 464+150000, 0, 0, Xi))
        { 
          Send, {Space}
          Sleep, 1000
          break
        ...
        if (ok:=FindText(SaveLivesX, SaveLivesY, 961-150000, 609-150000, 961+150000, 609+150000, 0, 0, SaveLives))
        {
...
MuaDatCat() {
    ...
    Sleep, 1500
    MouseClick, left, 50, 196
    Sleep, 1500
    MouseClick, left, 280, 85
    Sleep, 1500
    MouseMove, 845, 300
    Sleep, 1000
    Click, WheelDown, 10
    ...
    if (ok:=FindText(DatCatX := "wait", DatCatY := 5, 536-150000, 196-150000, 536+150000, 196+150000, 0, 0, DatCat))
    {
      MouseClick, left, DatCatX, DatCatY
      Sleep, 1000
      ; plus
      MouseClick, left, 984, 490
      Sleep, 1000
      Send, {v}
      Sleep, 1000
...
BanKhoan() {
    ...
    if (ok:=FindText(BanX := "wait", BanY := 10, 83-150000, 551-150000, 83+150000, 551+150000, 0, 0, Ban))
    {
      MouseClick, left, BanX, BanY
      Sleep, 1000
      ; Rut tien
      Rut:="|<>*132$29.zk1U1zk603XUQ077Uk7C600CQQQQTskstzz1llny3XXbw777CwCCCQwQQQsssstltzlvlnzXv13W3c"
      if (ok:=FindText(RutX := "wait", RutY := 3, 874-150000, 640-150000, 874+150000, 640+150000, 0, 0, Rut))
      {
      ...
      loop, 8
      {
        ...
        if (ok:=FindText(GoX, GoY, 722-150000, 215-150000, 722+150000, 215+150000, 0, 0, Go))
        {
      ...
      if (ok:=FindText(KhoanX := "wait", KhoanY := 3, 190-150000, 157-150000, 190+150000, 157+150000, 0, 0, Khoan))
      {
        MouseClick, left, KhoanX, KhoanY
        Sleep, 1000
        ; Ha gia 8 lan
        MouseClick, left, 732, 479
        MouseClick, left, 732, 479
        MouseClick, left, 732, 479
        MouseClick, left, 732, 479
        MouseClick, left, 732, 479
        ...
        MouseClick, left, 732, 479
        Sleep, 500
        MouseClick, left, 971, 391
        Sleep, 500
        ; len ke
        LenKe:="|<>*119$18.s0Ms0ws0qs0as00skStlztXbv37y3zz7wz70vXUvnstvzslw00800M00Q00MU"
        if (ok:=FindText(LenKeX := "wait", LenKeY := 3, 958-150000, 651-150000, 958+150000, 651+150000, 0, 0, LenKe))
        {
...
FullGhepKhoan() {
    ...
    if (ok := FindText(NgheX := "wait", NgheY := 5, 895 - 150000, 202 - 150000, 895 + 150000, 202 + 150000, 0, 0, Nghe))
    {
        ...
        if (ok:=FindText(RenX := "wait", RenY := 5, 314-150000, 712-150000, 314+150000, 712+150000, 0, 0, Ren))
        {
            ...
            Sleep, 1000
              MouseClick, left, 192, 180
              Sleep, 1000
              ; Tinh luyen dong
              MouseClick, left, 240, 245
              Sleep, 1000
              ...
              if (ok:=FindText(PlusMaxX := "wait", PlusMaxY := 5, 658-150000, 611-150000, 658+150000, 611+150000, 0, 0, PlusMax))
              {
                MouseClick, left, PlusMaxX, PlusMaxY
                Sleep, 1000
                ; Che tao
                CheTao:="|<>*110$30.Ts000zs00070000700007000070A0M70z1y71bXz703a7703a770Ta371Xi371Xi371nb771zbw71vXsU"
                if (ok:=FindText(CheTaoX := "wait", CheTaoY := 5, 803-150000, 614-150000, 803+150000, 614+150000, 0, 0, CheTao))
                {
...
LogoutNhanVat() {
    ...
    Send, {Esc}
    Sleep, 1000
    MouseClick, left, 984, 430
    Sleep, 1000
    ; wait logout done
    loop
    {
      MouseClick, left, 456, 190
      Sleep, 1000
      Send, {Space}
      Sleep, 1000
      LoginSuccess:="|<>*116$19.z0Tzjbk000003zzzzznk00s00Q00C287143UW1kF0s8UQ4EC287143UW1k00s00Q00C007003"
      if (ok:=FindText(LoginSuccessX := "wait", LoginSuccessY := 3, 962-150000, 591-150000, 962+150000, 591+150000, 0, 0, LoginSuccess))
      {
        break
      }
      SaveLives:="|<>*153$30.zznzzzz3zzzz7zzzzDzzzzPzzzzbzzzzDzzzzPzzzznzzzz3zzzz3zzzU07zzyzjzzyDzzzy/zzzy9zzzy9yDzy9Uvzy9aBzy9zpzy9ztzy9zszu9zsza9zkzi9zVzy9z1zy9y1zy9w3zy9sLzy9Ubzy91Dzy86zzy0Bzzy0yzzy3xzzkDvz00zbzzzzDzU"
...
DoiNhanVat() {
    ...
    {
      LoginSuccess:="|<>*116$19.z0Tzjbk000003zzzzznk00s00Q00C287143UW1kF0s8UQ4EC287143UW1k00s00Q00C007003"
      if (ok:=FindText(LoginSuccessX := "wait", LoginSuccessY := 5, 962-150000, 591-150000, 962+150000, 591+150000, 0, 0, LoginSuccess))
      {
        Sleep, 1000
        MouseMove, 150, 300
        Sleep, 1000
...
QuaDuNgoan() {
    ...
    loop
    {
      ...
      if (ok:=FindText(X, Y, 52-150000, 39-150000, 52+150000, 39+150000, 0, 0, Text))
      {
        MouseClick, left, X, Y
        break
      }
...
MenuNauAn() {
    ...
    Gui, Add, Button, gNauAn2 Default w200, SashimiCaBac (Bang)
    Gui, Add, Button, gNauAn1 w200, CanhThachTuy (Hoa)
        ...
        if (ok := FindText(DanX := "wait", DanY := 5, 698 - 150000, 662 - 150000, 698 + 150000, 662 + 150000, 0, 0, Dan))
        {
            ...
            if (ok := FindText(DienTauX := "wait", DienTauY := 5, 949 - 150000, 564 - 150000, 949 + 150000, 564 + 150000, 0, 0, DienTau))
            {
                ...
                if (ok := FindText(PlusX := "wait", PlusY := 3, 1024 - 150000, 187 - 150000, 1024 + 150000, 187 + 150000, 0, 0, Plus))
                {
                    ...
                    MouseClickDrag, left, 932, 180, 932, 400
                    sleep, 360000 ; 6 phut
                    Send, {Esc}
                }
            }
...
MuaGiaVi() {
    ...
    if (ok:=FindText(GiaviX, GiaviY, 544-150000, 188-150000, 544+150000, 188+150000, 0, 0, Giavi))
    {
      MouseClick, left, GiaviX, GiaviY
      Sleep, 1000
      ; plus
