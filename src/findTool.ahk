...
PicFind(ini, j, dir, sx, sy, sw, sh)
{
  ...
  if !VarSetCapacity(init) && (init:="1")
  {
    x32:="VVdWU4HslAAAAIuEJPQAAACLtCT4AAAAg7wkqAAAAAWNBLCJRCQ4D4QqBgAAi4Qk"
    . "5AAAAIXAD45CEQAAMf@HRCQIAAAAADHtiTwki7wk4AAAAMdEJBgAAAAAx0QkDAAA"
    . "AACLhCTcAAAAi1QkDDH2MdsB0IX@iUQkBH876Y4AAAAPr4QkyAAAAInBifCZ9@8B"
    . "wYtEJASAPBgxdEyLhCTYAAAAg8MBA7Qk@AAAAIkMqIPFATnfdFSLBCSZ97wk5AAA"
    . "AIO8JKgAAAAEdbUPr4QkvAAAAInBifCZ9@+NDIGLRCQEgDwYMXW0i0QkGIuUJNQA"
    . "AACDwwEDtCT8AAAAiQyCg8ABOd+JRCQYdawBfCQMg0QkCAGLnCQAAQAAi0QkCAEc"
    . "JDmEJOQAAAAPhTT@@@+LRCQYiWwkNA+vhCToAAAAwfgKiUQkLIuEJOwAAAAPr8XB"
    . "+AqJRCRAg7wkqAAAAAQPhPQFAACLhCTQAAAAA4QkyAAAAIu0JMAAAACJRCQki4Qk"
    . "vAAAAA+vhCTEAAAAjSywi4QkyAAAAIu0JLwAAAD32IO8JKgAAAABjQSGiUQkMA+E"
    . "7wUAAIO8JKgAAAACD4Q8CgAAg7wkqAAAAAMPhKANAACLhCTMAAAAhcAPjgcBAACL"
    . "hCTIAAAAx0QkCAAAAADHRCQMAAAAAIPoAYlEJASNdgCLhCTIAAAAhcAPjsEAAACL"
    . "RCQMi1wkJDHJi5Qk0AAAAL8DAAAAAcMB0A+2M4kEJOtljVb@uAIAAACD+gF2E4P@"
    . "AQ+UwoP9AQ+UwAnQD7bAAcCB5v0AAAC6AQAAAHQShf8PlMKF7YnXD5TCidYJ94n6"
    . "izQkCdCIBA6DwQE5jCTIAAAAdEGFyQ+2cwEPhP4SAAAPtjuDwwE7TCQED4Q1EAAA"
    . "D7ZrAYuEJPAAAACFwHWCjUb@g@gCGcCD4AKB5v0AAAAPlMLrq4u0JMgAAAABdCQM"
    . "g0QkCAGLRCQIOYQkzAAAAA+PGv@@@4O8JPAAAAABg5wkwAAAAP+LdCQYi1wkLLgA"
    . "AAAAOd4PT8aLdCRAOXQkNIlEJBh@CMdEJDQAAAAAi7wkyAAAAIu0JMwAAAArvCT8"
    . "AAAAK7QkAAEAAIO8JLQAAAAJD4SIAAAAi4QktAAAAIPoAYP4Bw+H2QIAAIP4A4lE"
    . "JFgPjtQCAADHRCRIAAAAAMdEJAwAAAAAO3wkSMdEJFAAAAAAD4zUAAAAO3QkUA+M"
    . "Ig8AAItMJEiLXCRYifgpyPbDAg9EwYtMJFCJwonwKcj2wwEPRMGD+wOJ0Q9PyA9P"
    . "wolMJAiJRCQE6QgOAABmkIn4jVYBx0QkaAAAAADB6B@HRCRkAQAAAMdEJFQAAAAA"
    . "AfjHRCRcAAAAAMdEJAwAAAAA0fiJRCQEifDB6B8B8NH4iUQkCI1HAYnDD6@aOdAP"
    . "TMKDwAiJnCSAAAAAicMPr9iJnCSEAAAAi5wkgAAAADlcJGh9GYucJIQAAAA5XCRc"
    . "x0QkYAAAAAAPjB8FAACLjCT0AAAAhckPhIAHAACLhCQAAQAAD6+EJPwAAACD+AEP"
    . "hGgHAACLlCS0AAAAhdIPhXABAACLRCQMg@gBD45jAQAAi3QkOIucJPQAAACD6AEx"
    . "7YlEJBDHRCQEAAAAAIksJI1+BItEJASLDCSLN4tEAwSFyYlEJAiJyHg3i0@8OfEP"
    . "huIHAACJ+o1r@OsOjXQmAIPqBItK@DnOcxeJCotMhQSJTIMEg+gBg@j@deS4@@@@"
    . "@4tUJDiDwAGDBCQBg8cEg0QkBASJNIKLdCQIiTSDiwQkO0QkEHWMi4Qk@AAAAA+v"
    . "wMH4AonFi4QkAAEAAA+vwMH4AolEJASLtCT0AAAAx0QkCAAAAAAxwJCNtCYAAAAA"
    . "i1wkCIscnolcJBAPt@vB6xCFwIkcJHQtMduNtgAAAACLDJ4Pt9Ep+g+v0jnVfg@B"
    . "6RArDCQPr8k7TCQEfBGDwwE5w3Xbi1wkEIkchoPAAYNEJAgBi1wkCDtcJAx1ooHE"
    . "lAAAAFteX13CXACLRCQMOYQk+AAAAA+PjAwAAIuEJAABAAAPr4Qk@AAAAIP4AQ+E"
    . "6QUAAIuEJPwAAAAPr8DB+AKJxYuEJAABAAAPr8DB+AKJRCQEi0QkDIXAD48n@@@@"
    . "McDrmsdEJFgAAAAAifDHRCRIAAAAAIn+x0QkDAAAAACJx+kh@f@@McCDvCSsAAAA"
    . "Ag+UwIlEJGwPhGEGAAAxwIO8JKwAAAABD5TAiUQkcIuEJLAAAACFwA+EMgwAAIu0"
    . "JNQAAACLlCSwAAAAMe2LnCTcAAAAi7wk2AAAAI0ElolEJASLC4PGBIPDWIPHBInI"
    . "wegQD6+EJAABAACZ97wk5AAAAA+vhCS8AAAAiQQkD7fBD6+EJPwAAACZ97wk4AAA"
    . "AIsUJI0EgolG@ItDrI1ERQCDxRaJR@w7dCQEdaaLhCSwAAAAiYwkrAAAAIlEJBiL"
    . "hCToAAAAD6+EJLAAAADB+AqJRCQsi4Qk3AAAAMdEJEAAAAAAx0QkNAAAAACDwAiJ"
    . "RCQQ6Z77@@+LhCSsAAAAwegQD6+EJAABAACZ97wk5AAAAA+vhCS8AAAAicEPt4Qk"
    . "rAAAAA+vhCT8AAAAmfe8JOAAAACNBIGJhCSsAAAA6VP7@@+LhCTkAAAA0aQksAAA"
    . "AA+vhCTgAAAAA4Qk3AAAAIlEJBCLhCTMAAAAhcAPjhP7@@+LhCTIAAAAieqLbCQQ"
    . "x0QkKAAAAADHRCQ8AAAAAMHgAolEJEwxwIu8JMgAAACF@w+ONQEAAIu0JLgAAAAB"
    . "1gNUJEyJdCQUi3QkJAN0JDyJVCREA5QkuAAAAIl0JByJVCQgi1wkFA+2cwIPtnsB"
    . "D7YbiXQkBDH2ObQksAAAAIl8JAiJXCQMdnONtgAAAACLVLUAg8YCi3wkBItctfyJ"
    . "0A+2zg+20itUJAzB6BArTCQID7bAKfiB+@@@@z+JFCR3P4n6jbx4AAQAAA+vyQ+v"
    . "+MHhCw+v+I0EUIsUJAHPuf4FAAApwQ+vyg+v0QH6OdNzQjHAObQksAAAAHeTicLr"
    . "PYnfwe8QifoPtvoPr8APr@85+HfdD7bHD6@JD6@AOcF30IsEJA+22w+v24nCD6@Q"
    . "Odp3vroBAAAAuAEAAACLdCQcg0QkFASLXCQUiBaDxgE7XCQgiXQkHA+FBv@@@4uc"
    . "JMgAAAABXCQ8i1QkRINEJCgBA1QkMIt0JCg5tCTMAAAAD4Wi@v@@6YP4@@+J+In3"
    . "icaLRCRUhcAPhSIJAACDbCQIAYNEJGABg0QkXAGLVCRkOVQkYA+MGAgAAItcJFSJ"
    . "2IPgAQHCidiDwAGJVCRkg+ADiUQkVOmN+v@@iUQkMItEJGyFwA+F9QoAAItEJBCL"
    . "bCQUMduJRCRMi0QkLIXtiQQkD4SQAQAAiXwkJIl0JCCJ34uEJNQAAACLVCQwi3Qk"
    . "TIucJLgAAAADFLiLhCS4AAAAiXQkPA+2bBACD7YcE2vHFolEJCiLBonpweEQiZwk"
    . "kAAAAIlEJESLhCTYAAAAiwS4iYQksAAAAIuEJLgAAAAPtkQQAYmEJIwAAADB4AgJ"
    . "yAnYiYQkiAAAAOs2jbRpAAQAAA+v0g+v8cHiCw+v8Y0MaQHyvv4FAAApzonxD6@I"
    . "D6@BAcI50w+DpQAAAINEJDwIi0QkKDuEJLAAAAAPg+0JAACLVCRwi3QkPINEJCgC"
    . "hdKLBoteBHQPhf8PhPQKAACLhCSsAAAAicEPttQrlCSMAAAAwekQD7bAK4QkkAAA"
    . "AA+2ySnpgfv@@@8@iVQkHA+GZv@@@4newe4QifIPtvIPr8kPr@Y58XeDi3QkHA+2"
    . "zw+vyYnyD6@WOcoPh2z@@@8PttsPr8APr9s52A+HW@@@@4F8JET@@@8AdhKF@w+E"
    . "XwkAAIMsJAEPiFUJAACDxwGDRCRMWDl8JBQPhYL+@@+LdCQgi3wkJIuEJPQAAACD"
    . "RCQMAYtcJAyFwA+E+AYAAItUJAgDlCTEAAAAjYv@@@8@i0QkBAOEJMAAAACLrCS0"
    . "AAAAweIQCdCLlCT0AAAAhe2JBIoPhSH6@@+LRCQsKwQkOZwk+AAAAItUJDiJBIoP"
    . "j7EGAACLhCQAAQAAD6+EJPwAAACD+AEPhaf4@@+LRCQMgcSUAAAAW15fXcJcAIuE"
    . "JKwAAACLtCTMAAAAxwQkAAAAAMdEJAQAAAAAg8ABweAHiYQkrAAAAIuEJMgAAADB"
    . "4AKF9olEJAyJ6IusJKwAAAAPjp@2@@+LnCTIAAAAhdt+XIuMJLgAAACLXCQki7wk"
    . "uAAAAANcJAQBwQNEJAyJRCQIAccPtlECD7ZBAQ+2MWvAS2vSJgHCifDB4AQp8AHQ"
    . "OcUPlwODwQSDwwE5+XXVi5wkyAAAAAFcJASLRCQIgwQkAQNEJDCLNCQ5tCTMAAAA"
    . "dYXpGPX@@4sEJOlC+P@@i4Qk5AAAAIu0JNwAAAAPr4Qk4AAAANGkJLAAAACNBIaJ"
    . "xolEJBCLhCTsAAAAi04EwfgKg8ABD7bViUQkIInID7bJwegQD7bAicYPr@CJ0A+v"
    . "wol0JHSJRCR4icgPr8GJRCR8i4Qk5AAAAIXAD45XCAAAi3QkIIuEJAABAADHRCQs"
    . "AAAAAMdEJBgAAAAAD6@GiUQkPIuEJOAAAAAPr8bB4AKJRCRAi4Qk3AAAAIPAAolE"
    . "JDCJ8I00tQAAAACJdCQoicYPr4Qk@AAAAIl0JDSJRCQki4Qk4AAAAIXAD46QAQAA"
    . "i0QkMMdEJBwAAAAAiUQkDItEJCCJRCQUkI20JgAAAACLRCQMvwIAAAAPtlj@D7Yw"
    . "D7ZA@olcJASJRCQIjXQmADm8JLAAAAAPhuMAAACLRCQQixS4g8cCi1y4@A+2zonQ"
    . "K0wkBMHoEA+20itUJAgPtsAp8IH7@@@@P4kMJHdijaxwAAQAAA+vyQ+v6MHhCw+v"
    . "6I0EcAHNuf4FAAApwQ+vyg+v0QHqOdNyl4t0JBSLRCQgi3wkKAF8JAyLfCQkAXwk"
    . "HAHwObQk4AAAAA+OwAAAAIlEJBTpR@@@@420JgAAAACJ3cHtEInpD7bpD6@AD6@t"
    . "OegPh0j@@@+LLCQPtscPr8CJ6Q+vzTnBD4cy@@@@D7bbD6@SD6@bOdp2jjm8JLAA"
    . "AAAPhyX@@@+QjbQmAAAAAItEJCyLfCQYweYQmY0cvQAAAAD3vCTkAAAAD6+EJLwA"
    . "AACJwYtEJByZ97wk4AAAAIuUJNQAAACNBIGJBLqLRCQEg8cBiXwkGMHgCAnGC3Qk"
    . "CIuEJNgAAACJNBjpGf@@@4t0JDSLRCQgi3wkPAF8JCyLfCRAAXwkMAHwObQk5AAA"
    . "AA+O7wEAAIlEJDTpMf7@@4uMJMwAAACFyQ+OZ@P@@4u0JMgAAACLRCQkxwQkAAAA"
    . "AMdEJAQAAAAAjQRwiUQkHInwweACiUQkCIuUJMgAAACF0n5Xi4wkuAAAAItcJByL"
    . "vCS4AAAAA1wkBAHpA2wkCAHvD7ZRAoPBBIPDAWvyJg+2Uf1rwkuNFAYPtnH8ifDB"
    . "4AQp8AHQwfgHiEP@Ofl10ou0JMgAAAABdCQEgwQkAQNsJDCLBCQ5hCTMAAAAdYqL"
    . "hCTIAAAAi5QksAAAADHtMfaD6AGJRCQMi4QkzAAAAIPoAYlEJBSLhCTIAAAAhcAP"
    . "juUAAACLnCTIAAAAi0QkHAHzjQwwid+JXCQgicMB+4t8JCSJXCQEifMrnCTIAAAA"
    . "Af6JdCQIAcMxwIkcJI12AIXAD4RHAgAAOUQkDA+EPQIAAIXtD4Q1AgAAOWwkFA+E"
    . "KwIAAA+2EQ+2ef++AQAAAAOUJKwAAAA5+nJGD7Z5ATn6cj6LPCQPtj85+nI0i1wk"
    . "BA+2Ozn6cimLPCQPtn@@OfpyHos8JA+2fwE5+nITD7Z7@zn6cgsPtnMBOfIPksOJ"
    . "3ot8JAiJ84gcB4PAAYPBAYNEJAQBgwQkATmEJMgAAAAPhVr@@@+LdCQgg8UBOawk"
    . "zAAAAA+F@P7@@4mUJLAAAADpifD@@4tEJBjHRCRAAAAAAA+vhCToAAAAx0QkNAAA"
    . "AADB+AqJRCQs6Xjx@@@HRCRAAAAAAMdEJCwAAAAAx0QkNAAAAADHRCQYAAAAAOmz"
    . "7@@@i0QkBIXAD4iz9@@@OfgPj6v3@@+LRCQIhcAPiJ@3@@858A+Pl@f@@4NEJGgB"
    . "ifCJ@onHi1wkNItEJBg5ww9Nw4O8JKgAAAADicOJRCQUi0QkCA+P8QAAAA+vhCTI"
    . "AAAAA0QkBIXbD4RqAwAAA4Qk0AAAAItUJCyLXCRAiRQkMdKJweszifaNvCcAAAAA"
    . "OVQkNH4Xi6wk2AAAAItElQAByPYAAXUFg+sBeCuDwgE5VCQUD4QO+f@@OVQkGH7Q"
    . "i6wk1AAAAItElQAByIA4AXe+gywkAXm4g7wktAAAAAkPhNb2@@+DRCRQAen68P@@"
    . "g3wkVAF0FYN8JFQCD4TNAgAAg2wkBAHpx@b@@4NEJAQB6b32@@+DRCRIAem48P@@"
    . "x0QkLAAAAADHRCQYAAAAAOlg9P@@vQMAAADpxe@@@4t0JAjGBAYC6S7+@@8DhCTE"
    . "AAAAi1QkBA+vhCS8AAAAA5QkwAAAAIO8JKgAAAAFjQSQD4SU9v@@iUQkJAOEJKwA"
    . "AACLnCS4AAAAD7ZcAwKJXCQci5wkuAAAAA+2XAMBiVwkKIucJLgAAAAPtgQDiUQk"
    . "MItEJBSFwA+EHAIAAItEJECJdCQgMe2J3olEJDyLRCQsiQQk6YwAAACNtCYAAAAA"
    . "OWwkNH5yi4Qk2AAAAItUJCQDFKgPtkwWAg+2RBYBD7YUFitEJCgrVCQwicsrXCQc"
    . "A0wkHA+vwIlUJESLVCQcweALjZRTAAQAAA+v0w+v04tcJEQBwrj+BQAAKcgPr8MP"
    . "r8MB0DmEJLAAAAByC4NsJDwBD4iMAAAAg8UBOWwkFA+EgAEAADlsJBgPjnH@@@+L"
    . "hCTUAAAAi1QkJAMUqA+2TBYCD7ZEFgEPthQWK0QkKCtUJDCJyytcJBwDTCQcD6@A"
    . "iVQkRItUJBzB4AuNlFMABAAAD6@TD6@Ti1wkRAHCuP4FAAApyA+vww+vwwHQOYQk"
    . "sAAAAA+DBv@@@4MsJAEPifz+@@+LdCQg6ev9@@+NdgCBfCRE@@@@AA+HsPb@@+mZ"
    . "9v@@i3QkIIt8JCTpyP3@@4tMJBSLRCQshcmJBCQPhKX2@@8x2+sWifaNvCcAAAAA"
    . "g8MBOVwkFA+EhgAAAIuUJNQAAACLRCQwi4wk2AAAAAMEmouUJLgAAACLDJkPtmwC"
    . "AonKweoQKdWLlCS4AAAAD6@tO2wkdA+2VAIBiFQkHIuUJLgAAAAPtgQCfyEPtlQk"
    . "HA+27SnqD6@SOVQkeHwOD7bRKdAPr8A7RCR8foODLCQBD4l5@@@@iYwkrAAAAOkV"
    . "@f@@iYwkrAAAAOn59f@@g0QkCAHp+vP@@4tEJCyJBCTp4@X@@4t0JCDp2vX@@78D"
    . "AAAA6fvs@@@HRCQsAAAAAMdEJEAAAAAAx0QkGAAAAADpYe3@@4u0JIgAAACJ8Im0"
    . "JKwAAADp@vT@@5CQkJCQkA=="
    x64:="QVdBVkFVQVRVV1ZTSIHsmAAAAEhjhCSAAQAASIu8JHgBAACD+QWJjCTgAAAAiZQk"
    . "6AAAAESJxUSJjCT4AAAARIukJCABAACLnCRQAQAAi7QkWAEAAEiNBIdIiUQkQA+E"
    . "0AUAAIX2D45CEAAAMf9Mi7QkQAEAAIusJIgBAACJfCQMi7wk4AAAAEUx7UUx0kUx"
    . "@0SJbCQIRImEJPAAAABmkExjXCQMRTHJRTHATAOcJEgBAACF238163oPH4AAAAAA"
    . "QQ+vxInBRInImff7AcFDgDwDMXQ8SYPAAUljx0EB6UGDxwFEOcNBiQyGfkNEidCZ"
    . "9@6D@wR1yQ+vhCQIAQAAicFEiciZ9@tDgDwDMY0MgXXESIuUJDgBAABJg8ABSWPF"
    . "QQHpQYPFAUQ5w4kMgn+9AVwkDINEJAgBRAOUJJABAACLRCQIOcYPhVT@@@9EieiL"
    . "rCTwAAAARIlsJAgPr4QkYAEAAMH4ColEJCCLhCRoAQAAQQ+vx8H4ColEJDCDvCTg"
    . "AAAABA+EogUAAE1j7Iu8JBABAABMiehIA4QkMAEAAEiJRCQYi4QkCAEAAA+vhCQY"
    . "AQAAjQS4i7wkCAEAAIlEJAxEieD32IO8JOAAAAABjQSHiUQkJA+EkgUAAIO8JOAA"
    . "AAACD4TSCQAAg7wk4AAAAAMPhOgMAACLhCQoAQAAhcAPjg0BAABEiXwkDImsJPAA"
    . "AABBjXQk@0yLdCQYRIu8JCgBAAAx@4usJHABAABFMe1FheQPjsIAAABNY80xyUG7"
    . "AwAAAEcPthQOT41EDgFMA4wkMAEAAOttDx+EAAAAAABBjVL@uAIAAACD+gF2FEGD"
    . "+wEPlMKD+wEPlMAJ0A+2wAHAQYHi@QAAALoBAAAAdA9FhdtBD5TChdsPlMJECdKD"
    . "wQEJ0EE5zEGIAXRMhclFD7YQD4RYEgAARQ+2WP9Jg8ABSYPBATnxD4RDDwAAQQ+2"
    . "GIXtdYtBjUL@g@gCGcCD4AJBgeL9AAAAD5TCg8EBCdBBOcxBiAF1tEUB5YPHAUE5"
    . "@w+PKf@@@0SLfCQMi6wk8AAAAIO8JHABAAABg5wkEAEAAP+LfCQIi3QkILgAAAAA"
    . "OfcPT8dEO3wkMIlEJAh@A0Ux@0WJ5ou8JCgBAABEK7QkiAEAACu8JJABAACDvCT4"
    . "AAAACQ+EhgAAAIuEJPgAAACD6AGD+AcPh5cCAACD+AOJRCRMD46SAgAAx0QkNAAA"
    . "AABFMe1EO3QkNMdEJDwAAAAAD4zLAAAAO3wkPA+MTA4AAIt0JEyLXCQ0RInwKdhA"
    . "9sYCD0TDi1wkPInCifgp2ED2xgEPRMOD@gOJ1g9P8A9PwkGJwukTDQAAZg8fRAAA"
    . "RInwjVcBx0QkZAAAAADB6B@HRCRgAQAAAMdEJEgAAAAARAHwx0QkWAAAAADR+EGJ"
    . "won4wegfAfjR+InGQY1GAYnDD6@aOdAPTMJFMe2DwAiJXCR8icMPr9iJnCSAAAAA"
    . "i1wkfDlcJGR9GYucJIAAAAA5XCRYx0QkXAAAAAAPjMAEAABIg7wkeAEAAAAPhDEH"
    . "AACLhCSQAQAAD6+EJIgBAACD+AEPhBkHAACLhCT4AAAAhcAPhT4BAABBg@0BD440"
    . "AQAAQY1F@kyLRCRATIucJHgBAABFMclFMdJIjRyFBAAAAEOLdAgEQ4sUCESJ0UOL"
    . "fAsETInQOfJ3EumCBwAAkEiD6AFBixSAOdZzHUGJVIAEQYsUg4PpAYP5@0GJVIME"
    . "dd5Ix8D@@@@@SYPBBEiDwAFJg8IBSTnZQYk0gEGJPIN1oESLjCSIAQAARIucJJAB"
    . "AABFD6@JRQ+v20HB+QJBwfsCTIuUJHgBAAAx9jHAZpBBiyyyie8Pt93B7xCFwHQq"
    . "RTHAQ4sMgg+30SnaD6@SQTnRfg3B6RAp+Q+vyUQ52XwTSYPAAUQ5wH@ZSGPQg8AB"
    . "QYkskkiDxgFBOfV@s0iBxJgAAABbXl9dQVxBXUFeQV@DRDmsJIABAAAPj8gLAACL"
    . "hCSQAQAAD6+EJIgBAACD+AEPhMwFAABEi4wkiAEAAESLnCSQAQAAMcBFD6@JRQ+v"
    . "20HB+QJBwfsCRYXtD49A@@@@65nHRCRMAAAAAIn4x0QkNAAAAABEifdFMe1Bicbp"
    . "Yf3@@zHAg7wk6AAAAAIPlMCJRCRoD4QuBgAAMcCDvCToAAAAAQ+UwEWFwIlEJGwP"
    . "hLULAABEiaQkIAEAAEyLjCRIAQAARTHAi7wkCAEAAEyLpCQ4AQAARTHSTIusJEAB"
    . "AABEi7QkiAEAAESLvCSQAQAARYsZSYPBWESJ2MHoEEEPr8eZ9@4Pr8eJwUEPt8NB"
    . "D6@Gmff7jQSBQ4kEhEGLQaxBjQRCQYPCFkOJRIUASYPAAUQ5xXe7i4QkYAEAAESL"
    . "pCQgAQAARImcJOgAAACJbCQID6@FwfgKiUQkIEiLhCRIAQAAx0QkMAAAAABFMf9I"
    . "g8AISIkEJOn3+@@@i4Qk6AAAAMHoEA+vhCSQAQAAmff+D6+EJAgBAACJwQ+3hCTo"
    . "AAAAD6+EJIgBAACZ9@uNBIGJhCToAAAA6bb7@@+J8ESLhCQoAQAAAe0Pr8NImEgD"
    . "hCRIAQAARYXASIkEJA+OgPv@@0KNNKUAAAAAx0QkEAAAAAAxwMdEJCgAAAAAv@4F"
    . "AABEiXwkUIl0JDhEiaQkIAEAAIuMJCABAACFyQ+OEAEAAEhjVCQMSIu0JAABAABF"
    . "Me1MY3QkKEwDdCQYTI1kFgJFD7YUJEyLBCRFMclBD7Z0JP9FD7ZcJP7rPQ8fRAAA"
    . "Ro28UAAEAAAPr8lED6@4weELRA+v+EKNBFBEAflBif9BKcdEifgPr8IPr9AByjnT"
    . "c2lJg8AIMcBBOekPgxABAABBixBBi1gEQYPBAonQD7bOD7bSwegQKfFEKdoPtsBE"
    . "KdCB+@@@@z92lkGJ30HB7xBFD7b@D6@ARQ+v@0Q5+HexD7bHD6@JD6@AOcF3pA+2"
    . "2w+v0g+v2znad5e6AQAAALgBAAAAQ4gULkmDxARJg8UBRDmsJCABAAAPjyL@@@+L"
    . "XCQ4AVwkDIucJCABAAABXCQog0QkEAGLTCQki3QkEAFMJAw5tCQoAQAAD4XD@v@@"
    . "RIt8JFBEi6QkIAEAAOn0+P@@RInwQYn+iceLRCRIhcAPhbQIAACD7gGDRCRcAYNE"
    . "JFgBi0wkYDlMJFwPjI0HAACLXCRIidiD4AEBwYnYg8ABiUwkYIPgA4lEJEjp7@r@"
    . "@4nC6U3@@@+JRCQoi0QkaIXAD4W@CgAASIsEJEUxyUSLXCQgSIlEJFCLRCQMhcAP"
    . "hJcBAABEiWwkEESJfCQYRIlUJCRIi4QkOAEAAItUJChIi5wkAAEAAEyLhCQAAQAA"
    . "RWvRFkIDFIiNQgJImEQPtiwDSItcJFCNQgFIY9JImIsLQQ+2BACJTCQ4SIuMJEAB"
    . "AACJhCSIAAAAweAIQossiUSJ6cHhEAnIQQ+2DBBJidgJyImMJIwAAACJhCSEAAAA"
    . "6z1GjbxrAAQAAA+v0kQPr@vB4gtED6@7Qo0ca0QB+kG@@gUAAEEp30SJ+w+v2A+v"
    . "wwHCOdEPg5AAAABJg8AIQTnqD4OoCQAAi1wkbEGDwgJBiwBBi0gEhdt0EE2FyQ+E"
    . "tAoAAIuEJOgAAACJww+21A+2wMHrECuUJIgAAAArhCSMAAAAD7bbRCnrgfn@@@8@"
    . "D4Zs@@@@QYnPQcHvEEUPtv8Pr9tFD6@@RDn7d44Ptt0Pr9IPr9s52neBD7bJD6@A"
    . "D6@JOcgPh3D@@@+BfCQ4@@@@AHYTTYXJD4QlCQAAQYPrAQ+IGwkAAEmDwQFIg0Qk"
    . "UFhEOUwkDA+Ph@7@@0SLbCQQRIt8JBhEi1QkJEGDxQFIg7wkeAEAAAAPhFgGAABJ"
    . "Y8WLlCQYAQAASIucJHgBAABIjQyFAAAAAIuEJBABAAAB8sHiEEQB0AnQi5Qk+AAA"
    . "AIlEC@yF0g+FRPr@@4tEJCBIi3QkQEQp2EQ5rCSAAQAAiUQO@A+PCgYAAIuEJJAB"
    . "AAAPr4QkiAEAAIP4AQ+F9vj@@0SJ6Ony+f@@i4Qk6AAAAIuUJCgBAABFMdsx20KN"
    . "NKUAAAAAg8ABweAHhdKJhCToAAAAD44o9@@@RItsJAyLvCToAAAATIu0JAABAABF"
    . "heR+VUxj00wDVCQYSWPFSY1MBgJFMcBmDx+EAAAAAAAPthEPtkH@RA+2Sf5rwEtr"
    . "0iYBwkSJyMHgBEQpyAHQOcdDD5cEAkmDwAFIg8EERTnEf81BAfVEAeNBg8MBRANs"
    . "JCREOZwkKAEAAHWT6ZX1@@9MidDpoPj@@4nwAe0Pr8PB4AJImEgDhCRIAQAASInH"
    . "SIkEJIuEJGgBAADB+AqDwAGJRCQMi0cEicIPtswPtsDB6hAPttKJ1w+v+ol8JHCJ"
    . "zw+v+Yl8JHSJxw+v+IX2iXwkeA+OQggAAIt8JAyLhCSQAQAAx0QkJAAAAADHRCQI"
    . "AAAAAESJpCQgAQAAiZwkUAEAAA+vx4l8JDCJtCRYAQAAiUQkOIn4D6@DweACSJhI"
    . "iUQkUEiLhCRIAQAASIlEJCiJ+MHgAkiYSIlEJBCLhCSIAQAAD6@HiUQkIEiLBCRI"
    . "g8AISIlEJBhEi4wkUAEAAEWFyQ+ORAEAAEiLdCQoRItkJAwx@0QPtk4CTItEJBhB"
    . "vgIAAABED7ZWAUQPth7rOUaNrEgABAAAQb@+BQAAD6@JRA+v6MHhC0QPr+hCjQRI"
    . "QSnHRIn4RAHpD6@CD6@QAco503NrSYPACEQ59Q+GgAAAAEGLEEGLWARBg8YCidAP"
    . "ts4PttLB6BBEKdFEKdoPtsBEKciB+@@@@z92lEGJ3UHB7RBFD7btD6@ARQ+v7UQ5"
    . "6HeyD7bHD6@JD6@AOcF3pQ+22w+v0g+v2znad5gPHwCLRCQMSAN0JBADfCQgRAHg"
    . "RDmkJFABAAB+Y0GJxOkj@@@@i0QkJItcJAhBweEQQcHiCEUJ0ZlMY8NFCdn3vCRY"
    . "AQAAD6+EJAgBAACJwYn4mfe8JFABAACNBIFIi4wkOAEAAEKJBIGJ2IPAAYlEJAhI"
    . "i4QkQAEAAEaJDIDrg4t8JDCLRCQMi1wkOAFcJCRIi1wkUEgBXCQoAfg5vCRYAQAA"
    . "D47ZAgAAiUQkMOl5@v@@i4QkKAEAAIXAD44l9P@@Q40EZIt0JAxCjTylAAAAAEUx"
    . "2zHbSJhIA4QkMAEAAEmJxkWF5H5WSIuMJAABAABIY8ZMY9NFMcBNAfJIjUwBAmaQ"
    . "D7YRSIPBBERryiYPtlH7a8JLQY0UAUQPtkn6RInIweAERCnIAdDB+AdDiAQCSYPA"
    . "AUU5xH@KAf5EAeNBg8MBA3QkJEQ5nCQoAQAAdZNJjUUBRIl8JCREi7wk6AAAAEGN"
    . "dCT@RTHSx0QkDAAAAABIiUQkELgBAAAATCnoSYnFi4QkKAEAAI14@0WF5A+O0QAA"
    . "AExjTCQMSItEJBBIi1wkGE6NBAhLjUwNAEuNVA4BMcBMActNAfBMAfEPH4AAAAAA"
    . "SIXAD4Q2AgAAOcYPhC4CAABFhdIPhCUCAABEOdcPhBwCAAAPtmr@RA+2Sv5BuwEA"
    . "AABEAf1EOc1yRkQPtgpEOc1yPUQPtkn@RDnNcjNFD7ZI@0Q5zXIpRA+2Sf5EOc1y"
    . "H0QPtglEOc1yFkUPtkj+RDnNcgxFD7YIRDnNQQ+Sw5BEiBwDSIPAAUiDwgFJg8AB"
    . "SIPBAUE5xA+PY@@@@0QBZCQMQYPCAUQ5lCQoAQAAD4UU@@@@RIt8JCTpWPH@@8dE"
    . "JDAAAAAAx0QkIAAAAABFMf@HRCQIAAAAAOmu8P@@RYXSD4hD+P@@RTnyD486+P@@"
    . "hfYPiDL4@@85@g+PKvj@@4NEJGQBifhEifdBicaLRCQIQTnHQQ9Nx4O8JOAAAAAD"
    . "icOJRCQMifAPjxoBAABBD6@EhdtGjQQQD4TOAwAARItMJDBEi1wkIDHJSIuEJDAB"
    . "AADrL0Q7fCQQfhpIi5wkQAEAAESJwgMUi@YEEAF1BkGD6QF4MkiDwQE5TCQMD465"
    . "+f@@OUwkCIlMJBB+x0iLlCQ4AQAARInDAxyKgDwYAXezQYPrAXmtg7wk+AAAAAkP"
    . "hG33@@+DRCQ8Aen58f@@i0QkCESLpCQgAQAARTH@D6+EJGABAADHRCQwAAAAAMH4"
    . "ColEJCDpSfH@@4N8JEgBdBSDfCRIAg+ECAMAAEGD6gHpNPf@@0GDwgHpK@f@@4NE"
    . "JDQB6Y3x@@8PH4QAAAAAALsDAAAA6bfw@@@HRCQgAAAAAMdEJAgAAAAA6d30@@@G"
    . "BAMC6Tz+@@8DhCQYAQAAi5QkEAEAAA+vhCQIAQAARAHSg7wk4AAAAAWNBJAPhAb3"
    . "@@+JRCQkA4Qk6AAAAEiLnCQAAQAAi0wkDI1QAoXJSGPSD7YcE41QAUiYSGPSiVwk"
    . "EEiLnCQAAQAAD7YcE4lcJChIi5wkAAEAAA+2BAOJRCQ4D4RFAgAAi0QkMESJVCQY"
    . "MdtEi1wkIEyLlCQAAQAAiUQkUOmZAAAADx+EAAAAAABEO7wkhAAAAH55SIuEJEAB"
    . "AACLVCQki0wkEAMUmI1CAkiYRQ+2BAKNQgFIY9JBD7YUEkiYK1QkOEEPtgQCRYnB"
    . "K0QkKEQDRCQQQSnJQY2MSQAEAABBD6@JD6@AQQ+vycHgCwHBuP4FAABEKcAPr8IP"
    . "r8IBwTnNcguDbCRQAQ+ImwAAAEiDwwE5XCQMD46VAQAAOVwkCImcJIQAAAAPjl7@"
    . "@@9Ii4QkOAEAAItUJCSLTCQQAxSYjUICSJhFD7YEAo1CAUhj0kEPthQSSJgrVCQ4"
    . "QQ+2BAJFicErRCQoRANEJBBBKclBjYxJAAQAAEEPr8kPr8BBD6@JweALAcG4@gUA"
    . "AEQpwA+vwg+vwgHIOcUPg+z+@@9Bg+sBD4ni@v@@RItUJBjpj@3@@w8fhAAAAAAA"
    . "gXwkOP@@@wAPh+r2@@@p0vb@@0SLbCQQRIt8JBhEi1QkJOlg@f@@i0QkDESLXCQg"
    . "hcAPhOT2@@9FMcBIi4wkAAEAAOsPSYPAAUQ5RCQMD46EAAAASIucJDgBAACLRCQo"
    . "QgMEg0iLnCRAAQAAQosUg0SNSAJNY8lCD7YcCUGJ0UHB6RBEKctEjUgBSJgPr9s7"
    . "XCRwD7YEAU1jyUYPtgwJfyEPtt5BKdlFD6@JRDtMJHR@EEQPtspEKcgPr8A7RCR4"
    . "foNBg+sBD4l5@@@@iZQk6AAAAOmv@P@@iZQk6AAAAOk49v@@g8YB6S30@@9Ei1wk"
    . "IOkm9v@@RItUJBjpHPb@@0G7AwAAAOmi7f@@x0QkIAAAAADHRCQwAAAAAMdEJAgA"
    . "AAAA6Qju@@+LnCSEAAAAidiJnCToAAAA6T71@@+QkJA="
...
int __attribute__((__stdcall__)) PicFind(
  ...
  , int new_w, int new_h )
{
  int ok, o, i, j, k, v, e1, e0, len1, len0, max, pic, shape, dir1;
  ...
  unsigned char *ts, *gs;
  ok=0; o=0; len1=0; len0=0; ts=ss+sw; gs=ss+sw*3; arr=allpos+allpos_max;
  //----------------------
  if (mode==5)
  {
    if (pic=(c==2))  // FindPic
  ...
  {
    cors=(unsigned int *)(text+w*h); n*=2; v=0;
    for (y=0; y<sh; y++, o+=j)
      ...
      else if (mode==5)
      {
        ...
        else
        {
          for (i=0; i<max; i++)
          {
            ...
            {
              c1=cors[j++]; c2=cors[j++];
              if (shape) { if (i==0) c=rr<<16|gg<<8|bb; c1=c; }
              r=((c1>>16)&0xFF)-rr; g=((c1>>8)&0xFF)-gg; b=(c1&0xFF)-bb;
              v=(c2<0x40000000) ? ((1024+r+rr+rr)*r*r+2048*g*g+(1534-(r+rr+rr))*b*b<=c2)
              : (r*r<=((c2>>16)&0xFF)*((c2>>16)&0xFF)
              && g*g<=((c2>>8)&0xFF)*((c2>>8)&0xFF)
    ...
    else  ; <FindMultiColor> or <FindColor> or <FindShape>
    {
      ...
      For k1,v1 in arr
      {
        ...
        Loop % n1
          ...
          , k1:=(InStr(v1,"-")=1 || (shape && !v1) ? 0x1000000:0)
